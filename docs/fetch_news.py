...
OFFICIAL_SOURCES = [
    ...
    {"name": "AI Agent · Pre-listing", "url": "https://news.google.com/rss/search?q=%22Lotus%20AI%22%20OR%20%22Slingshot%20AI%22%20OR%20%22E2B%22%20%22AI%20sandbox%22%20OR%20%22AI%20agent%22&hl=en-US&gl=US&ceid=US:en"},
...
PORTFOLIO_KEYWORDS = {
    ...
    "ai-agent-prelist": [
        ...
        "lotus ai", "slingshot ai", "e2b", "agent infrastructure", "workflow automation",
        "AI Agent", "智能体", "运行沙盒", "开发者智能体", "Lotus AI", "Slingshot AI", "E2B",
    ],
    "huawei": [
