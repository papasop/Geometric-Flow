...
PORTFOLIO_KEYWORDS = {
    ...
    "ai-agent-prelist": [
        ...
        "nebius", "nebius group", "nbis", "servicenow", "service now", "now stock", "nyse now", "microsoft", "msft", "copilot", "microsoft copilot", "autonomous agents", "enterprise agent platform",
        ...
        "AI Agent", "智能体", "运行沙盒", "开发者智能体", "企业工作流", "AI 推理芯片", "心理咨询", "法律服务", "Nebius", "NBIS", "ServiceNow", "Microsoft", "Copilot", "Etched AI", "Lotus AI", "Slingshot AI", "GetDynasty", "E2B",
    ],
    "huawei": [
