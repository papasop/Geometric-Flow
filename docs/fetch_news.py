...
PORTFOLIO_KEYWORDS = {
    ...
    "ai-cloud": [
        ...
        "nebius", "nebius group", "nbis", "coreweave", "crwv", "iren", "applied digital", "apld", "terawulf", "wulf", "hut 8", "hut", "core scientific", "corz", "digital realty", "dlr", "equinix", "eqix", "lambda labs", "lambda",
        ...
        "Nebius", "CoreWeave", "IREN", "Applied Digital", "TeraWulf", "Hut 8", "Core Scientific", "Digital Realty", "Equinix", "Lambda Labs", "新云", "AI 新云",
    ],
    "huawei": [
