...
OFFICIAL_SOURCES = [
    ...
    {"name": "AI Agent · Components", "url": "https://news.google.com/rss/search?q=%22ServiceNow%22%20OR%20%22NOW%20stock%22%20OR%20%22NYSE%20NOW%22%20OR%20%22Microsoft%20Copilot%22%20OR%20%22MSFT%22%20OR%20%22Lotus%20AI%22%20OR%20%22Slingshot%20AI%22%20OR%20%22GetDynasty%22%20OR%20%22E2B%22%20%22AI%20sandbox%22%20OR%20%22AI%20agent%22&hl=en-US&gl=US&ceid=US:en"},
...
PORTFOLIO_KEYWORDS = {
    ...
    "ai-agent-prelist": [
        ...
        "servicenow", "service now", "now stock", "nyse now", "microsoft", "msft", "copilot", "microsoft copilot", "autonomous agents", "enterprise agent platform",
        "lotus ai", "slingshot ai", "getdynasty", "e2b", "agent infrastructure", "workflow automation", "mental health ai", "legal ai",
        "AI Agent", "智能体", "运行沙盒", "开发者智能体", "企业工作流", "心理咨询", "法律服务", "ServiceNow", "Microsoft", "Copilot", "Lotus AI", "Slingshot AI", "GetDynasty", "E2B",
    ],
    "huawei": [
