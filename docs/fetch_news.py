...
OFFICIAL_SOURCES = [
    ...
    {"name": "Blockchain Short · Components", "url": "https://news.google.com/rss/search?q=Bitcoin%20OR%20BTC%20OR%20Ethereum%20OR%20ETH%20OR%20BNB%20OR%20XRP%20OR%20Solana%20OR%20SOL%20OR%20crypto%20market&hl=en-US&gl=US&ceid=US:en"},
...
PORTFOLIO_KEYWORDS = {
    ...
    "blockchain-short": [
        "bitcoin", "btc", "btc-usd", "ethereum", "eth", "eth-usd", "bnb", "bnb-usd", "xrp", "xrp-usd", "solana", "sol", "sol-usd",
        "crypto", "cryptocurrency", "blockchain", "digital assets", "加密货币", "区块链", "比特币", "以太坊",
        "Bitcoin", "Ethereum", "BNB", "XRP", "Solana", "区块链空头",
    ],
    "huawei": [
...
SOURCE_PORTFOLIO_MATCHES = {
    ...
    "Blockchain Short · Components": ["blockchain-short"],
