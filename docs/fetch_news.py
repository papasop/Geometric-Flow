...
PINNED_SECTION_ITEMS = {
    ...
    "papers": [
        ...
        },
        {
            ...
            "summary": "DualPath addresses KV-cache storage I/O bottlenecks in multi-turn agentic LLM inference by adding a storage-to-decode loading path and RDMA transfer to prefill engines.",
            "url": "https://arxiv.org/abs/2602.21548",
            "author": "Yongtong Wu, Shaoyuan Chen, Yinmin Zhong, Rilin Huang, Yixuan Tan, Wentao Zhang, Liyue Zhang, Shangyan Zhou, Yuxuan Liu, Shunfeng Zhou, Mingxing Zhang, Xin Jin, Panpan Huang",
            "publishedAt": "2026-02-26T02:04:07Z",
            "section": "papers",
            "sectionTitle": "论文",
            "matchedPortfolios": ["ai-market"],
            "tags": ["arXiv", "agentic LLM inference", "KV-cache", "storage bandwidth"],
        },
        {
            "source": "arXiv",
            "feedSource": "arXiv",
