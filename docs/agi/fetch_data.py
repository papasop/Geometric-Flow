...
COMPONENTS = [
    ...
    ("Ondas",                  "ONDS",           "ONDS",      1 / 14, "USD"),
    ("Unusual Machines",       "UMAC",           "UMAC",      1 / 14, "USD"),
    ("Theon International",    "THEON",          "THEON.AS",  1 / 14, "EUR"),
    ("Kopin",                  "KOPN",           "KOPN",      1 / 14, "USD"),
    ("Red Cat Holdings",       "RCAT",           "RCAT",      1 / 14, "USD"),
    ("Swarmer",                "SWMR",           "SWMR",      1 / 14, "USD"),
    ("Draganfly",              "DPRO",           "DPRO",      1 / 14, "USD"),
    ("LightPath Technologies", "LPTH",           "LPTH",      1 / 14, "USD"),
    ("Safe Pro Group",         "SPAI",           "SPAI",      1 / 14, "USD"),
    ("Kratos Defense & Security Solutions", "KTOS", "KTOS", 1 / 14, "USD"),
    ("Palladyne AI",           "PDYN",           "PDYN",      1 / 14, "USD"),
    ("AeroVironment",          "AVAV",           "AVAV",      1 / 14, "USD"),
    ("Palantir Technologies",  "PLTR",           "PLTR",      1 / 14, "USD"),
    ("HawkEye 360",            "HAWK",           "HAWK",      1 / 14, "USD"),
