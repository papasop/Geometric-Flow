...
COMPONENTS = [
    ...
    ("Ondas",                  "ONDS",           "ONDS",      1 / 15, "USD"),
    ("Unusual Machines",       "UMAC",           "UMAC",      1 / 15, "USD"),
    ("Theon International",    "THEON",          "THEON.AS",  1 / 15, "EUR"),
    ("Kopin",                  "KOPN",           "KOPN",      1 / 15, "USD"),
    ("Red Cat Holdings",       "RCAT",           "RCAT",      1 / 15, "USD"),
    ("Swarmer",                "SWMR",           "SWMR",      1 / 15, "USD"),
    ("Draganfly",              "DPRO",           "DPRO",      1 / 15, "USD"),
    ("LightPath Technologies", "LPTH",           "LPTH",      1 / 15, "USD"),
    ("Safe Pro Group",         "SPAI",           "SPAI",      1 / 15, "USD"),
    ("Kratos Defense & Security Solutions", "KTOS", "KTOS", 1 / 15, "USD"),
    ("Palladyne AI",           "PDYN",           "PDYN",      1 / 15, "USD"),
    ("AeroVironment",          "AVAV",           "AVAV",      1 / 15, "USD"),
    ("Palantir Technologies",  "PLTR",           "PLTR",      1 / 15, "USD"),
    ("HawkEye 360",            "HAWK",           "HAWK",      1 / 15, "USD"),
    ("BlackSky Technology",    "BKSY",           "BKSY",      1 / 15, "USD"),
    ...
    ("\u70ed\u666f\u751f\u7269", "热景生物",      "688068.SS", 0.0, "CNY"),
    ("\u4e4b\u6c5f\u751f\u7269", "之江生物",      "688317.SS", 0.0, "CNY"),
    ("\u7855\u4e16\u751f\u7269", "硕世生物",      "688399.SS", 0.0, "CNY"),
    ("\u535a\u62d3\u751f\u7269", "博拓生物",      "688767.SS", 0.0, "CNY"),
    ("\u62fc\u591a\u591a",      "PDD",            "PDD",       0.0, "USD"),
